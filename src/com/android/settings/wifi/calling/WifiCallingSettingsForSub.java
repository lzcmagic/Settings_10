...
public class WifiCallingSettingsForSub extends SettingsPreferenceFragment
    ...
    public static final String EXTRA_KEY_ALERT_TITLE =  android.telephony.ims.ImsManager.EXTRA_WFC_REGISTRATION_FAILURE_TITLE;
    public static final String EXTRA_KEY_ALERT_MESSAGE =  android.telephony.ims.ImsManager.EXTRA_WFC_REGISTRATION_FAILURE_MESSAGE;
    @VisibleForTesting
    void showAlert(Intent intent) {
        final Context context = getActivity();

        final CharSequence title = intent.getCharSequenceExtra(EXTRA_KEY_ALERT_TITLE);
        final CharSequence message = intent.getCharSequenceExtra(EXTRA_KEY_ALERT_MESSAGE);
    ...
    public void onResume() {
        ...
        if (intent.getBooleanExtra(EXTRA_KEY_ALERT_SHOW, false)) {
            showAlert(intent);
        }
